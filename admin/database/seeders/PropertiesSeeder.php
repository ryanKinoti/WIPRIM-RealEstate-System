    ...
    public function run()
    {
        ...
        DB::table('properties')->insert([
            [
                ...
                //'location' => DB::raw("GeomFromText('POINT(36.93444287989289 -1.3750562040125158)')"), // Longitude, Latitude
                'number_of_floors' => '5',
            ...
            [
                ...
                //'location' => DB::raw("GeomFromText('POINT(36.9670644663952 -1.3541471335107707)')"), // Longitude, Latitude
                'number_of_floors' => '1',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
